    ...
    <div className="max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className="flex flex-col h-full justify-center">
        ...
        <p className="pb-6">
          ...
          voluptas, modi saepe totam atque, vel natus nihil deserunt laboriosam
          impedit. Numquam cupiditate sint incidunt laudantium asperiores
          praesentium officiis voluptas?
        </p>
        <div>
